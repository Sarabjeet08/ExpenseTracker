    ...
    <div class="container-fluid">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="home.php">
                    <span class="navbar-brand mb-0 h1" style="color:rgb(204, 164, 52);">
        ...
        <div class="dropdown me-3">
            ...
            <ul class="dropdown-menu me-5" aria-labelledby="dropdownMenuLink">
                <?php if (basename($_SERVER['PHP_SELF']) === 'user-profile.php'): ?>
                    <li><a class="dropdown-item" href="home.php"><i class="fa fa-lg fa-home me-2" aria-hidden="true"></i>Home</a></li>
                <?php else: ?>
                    <li><a class="dropdown-item" href="user-profile.php"><i class="fa fa-lg fa-user me-2" aria-hidden="true"></i>Profile</a></li>
                <?php endif; ?>
