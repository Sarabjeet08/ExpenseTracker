...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="row mt-5 mb-2">
                ...
                <div class="col-6">
                    <canvas id="expense-category" width="600" height="400"></canvas>
                </div>
                <div class="col-6">
                    <canvas id="expense-trend" width="600" height="400"></canvas>
                </div>
            </div>
                ...
                <div class="card shadow bg-body rounded" style="width: 100%; background-color: #f9f9f9;"> <!-- Updated background -->
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-bordered text-nowrap text-center table-striped align-middle pt-3">
    ...
    <div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="CreateLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                <div class="container">
                    <form action="../View/expense.php" method="POST" autocomplete="">
    ...
    <script>
        // Fetch data for Expense by Category chart
        fetch('../API/getExpenseBarGraphData.php')
            .then(response => response.json())
            .then(data => {
                const ctx = document.getElementById('expense-category').getContext('2d');
                new Chart(ctx, {
                    type: 'bar',
                    data: {
        ...
        // Fetch data for Expense Trend chart
        fetch('../API/getExpenseLineGraphData.php')
            .then(response => response.json())
            .then(data => {
